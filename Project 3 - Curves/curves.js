...
// ===YOUR CODE STARTS HERE===
	let array = controlPts.slice(0);
	function Q(t) {
		for(let i = 0; i < array.length - 1; i++){
			let X = (1-t) * array[i].x + t * array[i+1].x;
			let Y = (1-t) * array[i].y + t * array[i+1].y;
			array[i] = {x: X, y: Y};
		}
		return array[0];
	}
...
// ===YOUR CODE STARTS HERE===
		...
		if(closedCurve === true) {
			for(let i = 0; i < array.length; i++) {
				for(let j = 0; j <= nSegment; j++) {
					...
					let Y = 0;
					if (i === (array.length - 3)) { 
						X = ((array[i].x * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].x * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].x * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[0].x * (1/6*Math.pow(t,3))));
						Y = ((array[i].y * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].y * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].y * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[0].y * (1/6*Math.pow(t,3))));;
					}
					else if (i === (array.length - 2)) {
						X = ((array[i].x * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].x * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[0].x * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[1].x * (1/6*Math.pow(t,3))));
						Y = ((array[i].y * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].y * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[0].y * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[1].y * (1/6*Math.pow(t,3))));;
					}
					else if (i === (array.length - 1)) {
						X = ((array[i].x * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[0].x * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[1].x * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[2].x * (1/6*Math.pow(t,3))));
						Y = ((array[i].y * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[0].y * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[1].y * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[2].y * (1/6*Math.pow(t,3))));;
					}
					else {
						X = ((array[i].x * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].x * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].x * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[i+3].x * (1/6*Math.pow(t,3))));
						Y = ((array[i].y * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].y * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].y * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[i+3].y * (1/6*Math.pow(t,3))));
					}
		...
		if (closedCurve === false) {
			for(let i = 0; (i+3) < array.length; i++) {
				for(let j = 0; j <= nSegment; j++) {
					let t = j / nSegment;
					let X = ((array[i].x * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].x * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].x * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[i+3].x * (1/6*Math.pow(t,3))));
					let Y = ((array[i].y * ((-1/6*Math.pow(t,3)) + (1/2*Math.pow(t,2)) - (1/2*t) + 1/6)) + (array[i+1].y * ((1/2*Math.pow(t,3)) - (1*Math.pow(t,2)) + 2/3)) + (array[i+2].y * ((-1/2*Math.pow(t,3)) + (1/2*Math.pow(t,2)) + (1/2*t) + 1/6)) + (array[i+3].y * (1/6*Math.pow(t,3))));
					curvePts.push({x : X, y: Y});
				}
			}
		}
	...
	if(closedCurve === true) {
		for(let i = 0; i < array.length; i++) {
			for(let j = 0; j <= nSegment; j++) {
				...
				let Y = 0;
				if (i === (array.length - 1)) {
					let aX = (2*array[i].x + (-2*array[0].x) + (2*array[i].dx) + (2*array[0].dx));
					let aY = (2*array[i].y + (-2*array[0].y) + (2*array[i].dy) + (2*array[0].dy));
					let bX = (-3*array[i].x + (3*array[0].x) + (-4*array[i].dx) + (-2*array[0].dx));
					let bY = (-3*array[i].y + (3*array[0].y) + (-4*array[i].dy) + (-2*array[0].dy));
					let cX = (2*array[i].dx);
					let cY = (2*array[i].dy);
					let dX = (array[i].x);
					let dY = (array[i].y);
					X = ((aX * Math.pow(t,3)) + (bX * Math.pow(t,2)) + (cX * t) + dX);
					Y = ((aY * Math.pow(t,3)) + (bY * Math.pow(t,2)) + (cY * t) + dY);
				}
				else {
					let aX = (2*array[i].x + (-2*array[i+1].x) + (2*array[i].dx) + (2*array[i+1].dx));
					let aY = (2*array[i].y + (-2*array[i+1].y) + (2*array[i].dy) + (2*array[i+1].dy));
					let bX = (-3*array[i].x + (3*array[i+1].x) + (-4*array[i].dx) + (-2*array[i+1].dx));
					let bY = (-3*array[i].y + (3*array[i+1].y) + (-4*array[i].dy) + (-2*array[i+1].dy));
					let cX = (2*array[i].dx);
					let cY = (2*array[i].dy);
					let dX = (array[i].x);
					let dY = (array[i].y);
	...
	if (closedCurve === false) {
		for(let i = 0; (i+1) < array.length; i++) {
			for(let j = 0; j <= nSegment; j++) {
				...
				let dX = (array[i].x);
				let dY = (array[i].y);
				let X = ((aX * Math.pow(t,3)) + (bX * Math.pow(t,2)) + (cX * t) + dX);
				let Y = ((aY * Math.pow(t,3)) + (bY * Math.pow(t,2)) + (cY * t) + dY);
				curvePts.push({x : X, y: Y});
			}
		}
	}
